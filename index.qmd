---
title: "A guide to writing good code for the busy scientist"
...
## But good code doesn't just magically happen {background-color="#5C6836" style="color: #ffffff;font-size: 70%;"}
...
## Supporting good coding practices at the ALA {style="font-size: 90%;"}
...
## Code comments {background-color="#212932" style="color: #ffffff;" transition="fade"}
...
## Variables + Functions {background-color="#212932" style="color: #ffffff;" transition="fade"}
...
## What if you are a busy scientist short on time? {background-color="#212932" style="color: #ffffff;" transition="fade"}
...
# Summary {background-color="#212932" style="color: #ffffff; font-size: 70%" transition="fade"}
...
*  Write code like you write sentences
    -  Add spaces between operators (e.g. `+`, `-`, `*`)
...
*  Simple but understandable names, avoid acronyms
*  Make sure variable names align with terms in final paper
*  Define variables in a README or in-text section
...
When you're busy, prioritise readability!
